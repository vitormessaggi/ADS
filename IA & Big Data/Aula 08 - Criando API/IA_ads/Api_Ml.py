...
async def recebe_dados(data : InputData):
    ...
    #Carregand os modelos salvos
    scaler = joblib.load(pre_processamento)
    model = joblib.oad(modelo)
